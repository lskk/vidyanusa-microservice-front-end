...
angularModule.controller('controllerLeaderboard', function($scope, $http, $window){
  ...
  $http(reqLeaderboard).then(function(response){
    $scope.leaderboards = response.data.data
    //console.log("Data leaderboard: "+JSON.stringify(response.data.data))
  }, function(data){
...
//
angularModule.controller('controllerPencapaianPengguna', function($scope, $http, $window){
  $scope.pencapaian = function(kategoriKegiatan){
    var access_token = $('#hidden-access-token').text()
    var pengguna = $('#hidden-pengguna').text()
    ...
    $http(reqData).then(function(response){
      //$scope.hasilPencapaianDisiplin = response.data.data
      console.log("Pencapaian pengguna: "+response.data.data)
    })
  }
...
angularModule.controller('controllerPoinPerPengguna', function($scope, $http, $window){
  var user_id = $('#hidden-pengguna').text()
  ...
  $http(reqPoinPerPengguna).then(function(response){
    $scope.poinPengguna = response.data.data
    //console.log("Data leaderboard: "+JSON.stringify(response.data.data))
  }, function(data){
...
angularModule.controller('controllerKegiatanku', function($scope, $http, $window){
  var access_token = $('#hidden-access-token').text()
  var user_id = $('#hidden-pengguna').text()
  console.log("kegiatanku akses token: "+access_token)
  console.log("kegiatanku user id: "+user_id)
  ...
  $scope.ubahStatusKegiatan = function(kegiatan){
    ...
    $http(reqKegiatanku).then(function(response){
      ...
      if(status){
        alert("Kegiatan berhasil diterima.")
        ...
        alert("Kegiatan gagal diterima karena "+response.data.data.message)
      }
    }, function(data){
